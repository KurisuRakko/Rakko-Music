...
const CoverCard = ({
  ...
  /* 
    ...
    1. Check for `song.coverUrl` (Direct URL or Blob URL from Mystery/Import)
    2. Check for extracted/embedded art via `extractAlbumArt`
  */
  useEffect(() => {
    let mounted = true;
    ...
    const resolveCover = async () => {
      ...
      // 1. Direct URL (Mystery Code or predefined)
      if (song.coverUrl) {
        setCover(song.coverUrl);
        return;
      }

      // 2. Embedded Art Extraction
      if (song.file) {
